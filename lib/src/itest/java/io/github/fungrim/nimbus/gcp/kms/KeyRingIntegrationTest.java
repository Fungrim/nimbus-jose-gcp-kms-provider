 ...
 * needs a key ring with one or more keys to test with. Run it with the resource ID of the
 * key ring as a program argument: the test will find all supported keys and sign/verify both
 * JWT and JWS objects with all keys. 
 */
public class KeyRingIntegrationTest {
    
    /**
     * @param args First argument must be a key ring resource ID
